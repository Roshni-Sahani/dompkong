...
import men1 from "../assests/images/men1.png";
import men2 from "../assests/images/men2.png";
import men3 from "../assests/images/men3.png";
          ...
          <div className="position-relative">
            <Row className="yellowline pt-5">
              ...
              <Col className="pt-4 text-center text-lg-start">
                ...
                <p className="ff-montserrat fw-normal lh-109 text-white fs-s text-center text-lg-start">
                  Nearly two decades in Business
                </p>
                <p className="ff-montserrat fw-normal lh-160 text-white fs-xs max-w-540 pt-2 text-center text-lg-start">
                ...
                <p className="ff-montserrat fw-normal lh-160 text-white fs-xs max-w-540 text-center text-lg-start">
          ...
          <div className="position-relative">
            <Row className="yellowline pt-5 ">
              <Col lg={6} className="pt-4 text-center text-lg-start">
                ...
                <img src={men2} alt="team" className="men-img" />
              </Col>
              <Col className="pt-4 text-center text-lg-start">
                <p className="ff-montserrat fw-semibold lh-109 text-white fs-md">
                  @Talan Passaquindici Arcand
                </p>
                <p className="ff-montserrat fw-normal lh-109 text-white fs-s ">
                  Invester & International Top Model
                </p>
                <p className="ff-montserrat fw-normal lh-160 text-white fs-xs max-w-540 pt-2">
                ...
                <p className="ff-montserrat fw-normal lh-160 text-white fs-xs max-w-540">
          ...
          <div className="position-relative ">
            <Row className="yellowline pt-5 ">
              <Col lg={6} className="pt-4 text-center text-lg-start">
                ...
                <img src={men3} alt="team" className="men-img" />
              </Col>
              <Col className="pt-4 text-center text-lg-start">
                <p className="ff-montserrat fw-semibold lh-109 text-white fs-md ">
                  @Alfonso Franci
